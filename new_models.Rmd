...
Seasonal drop in average relative premium can probably be attributed to more Yeezys being sold proportianlly during holidays because it's a cheaper gift.?????



```{r visualizations4, echo=FALSE, dpi=300}
...
#vi5 = varImpPlot(yeezy_forest2, type=1, main = "Yeezy Random Forest with NCAA Data Variable Importance")
#vi6 = varImpPlot(nike_forest2, type=1, main = "Nike Random Forest with NCAA Data Variable Importance")
