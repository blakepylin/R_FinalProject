...
lm_1 = lm(premium ~ (shoe_size)^2 + monthly_retail + sp_index + Win_Percentage_2019:Year_month + Yrs + AP_Ranked_2018:Year_month + Final_Four_Appearances + AP_Final_Poll_Appearances + + disposable_per_cap_income + brand + sporting_goods + Overall_Win_Loss_Percentage + Win_Percentage_2018:Year_month + AP_Rank_2019:Year_month + NCAA_Tournament_Appearances + NCAA_Championships + heel_to_toe_cm + state_pop_year, data=premium_train)
