...
The color variables \emph{Primary Color} and \emph{Secondary Color} were the next most important, this isolates any effects color may have on buyer preferences that isn't captured by the name of the style. 
